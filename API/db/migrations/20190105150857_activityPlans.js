...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('activity_plans', table =>{
    table.increments()
    table.integer('user_id')
    table.string('plan_name')
    table.string('sunday_nonexercise_activity')
    ...
    table.string('monday_nonexercise_activity')
    ...
    table.string('tuesday_nonexercise_activity')
    ...
    table.string('wednesday_nonexercise_activity')
    ...
    table.string('thursday_nonexercise_activity')
    ...
    table.string('friday_nonexercise_activity')
    ...
    table.string('saturday_nonexercise_activity')
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('activity_plans')
};
